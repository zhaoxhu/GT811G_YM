...
typedef struct port_t {
 ...
 PORT_TIMER_T     local_loop_while;
  ...
  cs_uint64     adminPCost; /* may be ADMIN_PORT_PATH_COST_AUTO */
  cs_uint64     operPCost;
  cs_uint64     operSpeed;
  cs_uint64     usedSpeed;
  ...
  stp_p2p_admin_e       adminPointToPointMac;
  ...
  unsigned long     uptime;       /* 14.8.2.1.3.a */
   ...
   stp_port_loop_state_e       local_loop_state;

...
typedef void (*stp_polling_handler_t)(cs_uint32 port_index, cs_uint8 *frame_src_mac, cs_uint32 event);
typedef struct stpm_t {
  ...
  cs_port_id_t               rootPortId;     /* 17.17.5 */
  ...
  stp_polling_handler_t poll_handler;
} STPM_T;
...
const char*
STP_stpm_get_port_name_by_id (STPM_T* this, cs_port_id_t port_id);

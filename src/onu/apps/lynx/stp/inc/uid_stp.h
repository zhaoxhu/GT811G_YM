...
typedef struct {
  cs_int8      vlan_name[NAME_LEN]; /* name of the VLAN, key of the bridge */
  cs_int8      action; /* 1-create, 0- delete */
} stp_uid_br_ctrl_t;
...
typedef struct {
  /* service data */
  cs_uint64     field_mask; /* which fields to change */
...
typedef struct {
  ...
  cs_uint64     timeSince_Topo_Change; /* 14.8.1.1.3.b: TBD */
  cs_uint64     Topo_Change_Count;     /* 14.8.1.1.3.c: TBD */
  cs_uint8     Topo_Change;           /* 14.8.1.1.3.d: TBD */
...
typedef struct {
  ...
  /* protocol data */
  int           port_priority;
  cs_uint64 admin_port_path_cost; /* ADMIN_PORT_PATH_COST_AUTO - auto sence */
  stp_p2p_admin_e   admin_point2point;
  cs_uint8 admin_edge;
  cs_uint8 admin_non_stp; /* 1- doesn't participate in STP, 1 - regular */
#ifdef STP_DBG
  cs_uint32	skip_rx;
  cs_uint32	skip_tx;
#endif
...
typedef struct {
  /* service data */
  cs_int8              vlan_name[NAME_LEN]; /* name of the VLAN, key of the bridge */
  cs_uint32      port_no; /* key of the entry */

  /* protocol data */
  UID_PORT_ID       port_id;
  rstp_port_state_e   state;
  cs_uint64     path_cost;

  UID_BRIDGE_ID_T   designated_root;
  cs_uint64     designated_cost;
  UID_BRIDGE_ID_T   designated_bridge;
  UID_PORT_ID       designated_port;

#if 0
  int               infoIs;
  cs_uint16    handshake_flags;
#endif
  ...
  cs_uint64     uptime;       /* 14.8.2.1.3.a */
  cs_uint64     oper_port_path_cost;
  cs_uint8     role;
  cs_uint8     oper_point2point;
  cs_uint8     oper_edge;
  cs_uint8     oper_stp_neigb;
  cs_uint8     top_change_ack;
  cs_uint8     tc;

...
****************************************************************************/
#ifndef _APP_STATS_CTC_H_
#define _APP_STATS_CTC_H_

#ifdef HAVE_CTC_OAM
#include "oam_ctc_pdu.h"
#include "app_timer.h"

#define MONITOR_STATUS_DISABLE   1
#define MONITOR_STATUS_ENABLE    2
...
typedef struct{
    ...
    cs_uint32 port;
    cs_uint32 interval;
    oam_ctc_onu_port_stats_t last_save;         /*current period start stats*/
    oam_ctc_onu_port_stats_t last_duration;   /*last period stats*/
}ctc_stats_monitor_ctrl_t;

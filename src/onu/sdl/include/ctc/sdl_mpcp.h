 ...
 * sdl_mpcp.h
 *
 * $Id: sdl_mpcp.h,v 1.1.2.4.8.3.2.1.2.1 2012/05/25 07:44:24 hli2 Exp $
 */

#ifndef __SDL_MPCP_H__
#define __SDL_MPCP_H__
...
/********************************************************************************/
/* $rtn_hdr_start  epon_request_onu_mpcp_queue_threshold_set                    */
/* CATEGORY   : Device                                                          */
/* ACCESS     : Public                                                          */
/* BLOCK      : SAL                                                             */
/* CHIP       : 8030                                                            */
...
/*              o queue -- queue id 0~7                                         */
/*              o threshold -- queue set 2 threshold                            */
/*              o max_threshold -- queue set 1 threshold                        */
/*              And the range shall be: 0x0000 ~ 0xFFFF (65535).                */
/* OUTPUTS    : o NA                                                            */
/* RETURNS    : o result code, 0 - success, 1 - fail,                           */
/*              6 - invalid parameters                                          */
/* DESCRIPTION:                                                                 */
/* Configure queue threshold for Queue Set #2. Queue set threshold              */
/* shall impact the queue set #2 reporting                                      */
/* $rtn_hdr_end                                                                 */
/********************************************************************************/

/********************************************************************************/
/* $rtn_hdr_start  epon_request_onu_mpcp_queue_threshold_get                    */
/* CATEGORY   : Device                                                          */
/* ACCESS     : Public                                                          */
/* BLOCK      : SAL                                                             */
/* CHIP       : 8030                                                            */
...
/*              is intended for, -1 for synchronous invoking                    */
/*              o queue -- queue id 0~7                                         */
/* OUTPUTS    : o threshold -- queue set 2 threshold                            */
/*              o max_threshold -- queue set 1 threshold                        */
/* RETURNS    : o result code, 0 - success, 1 - fail,                           */
/*              6 - invalid parameters                                          */
/* DESCRIPTION:                                                                 */
/* Retrieve threshold for Queue Set #2                                          */
/* $rtn_hdr_end                                                                 */
/********************************************************************************/

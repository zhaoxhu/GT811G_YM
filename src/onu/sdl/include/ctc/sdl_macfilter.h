...
****************************************************************************/
#ifndef __SDL_MACFILTER_H__
#define __SDL_MACFILTER_H__
...
typedef struct{
        cs_sdl_mac_type_t   mac_type;
        cs_mac_t            mac;
        cs_uint16           vlanid;  //useless
        
}cs_sdl_mac_tbl_entry_t;
...
cs_status epon_request_onu_mac_filter_add_entry(
    ...
    CS_IN cs_uint8                 num,
    CS_IN cs_sdl_mac_tbl_entry_t   *mac_list/*[16]*/
);
...
cs_status epon_request_onu_mac_filter_get_entry(
    ...
    CS_OUT cs_sdl_mac_tbl_entry_t     *mac_list/*[16]*/
);
...
cs_status epon_request_onu_mac_filter_state_get (
    CS_IN  cs_port_id_t               port_id, 
    CS_OUT cs_sdl_mac_filter_type_t * filter_type 
);

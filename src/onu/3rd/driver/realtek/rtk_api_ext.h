 ...
 */
extern rtk_api_ret_t rtk_port_phyStatus_get(rtk_port_t port, rtk_port_linkStatus_t *pLinkStatus, rtk_port_speed_t *pSpeed, rtk_port_duplex_t *pDuplex, rtk_data_t *nego);
 ...
 */
extern rtk_api_ret_t rtk_l2_flushType_set(rtk_l2_flushType_t type, rtk_uint32 id, rtk_uint32 portOrTid);
...
extern rtk_api_ret_t rtk_port_phyMdx_get(rtk_port_t port, rtk_data_t *pMode);

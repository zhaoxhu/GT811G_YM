 ...
 * All rights reserved.
 *
 * $Revision: 1.1.2.1.2.25.10.2.4.1 $
 * $Date: 2013/11/28 08:45:44 $
 *
...
#define CHIP_RTL8305MB 1
//#define CHIP_RTL8365MB	1
...
typedef enum rtk_filter_field_type_e
{
    ...
    FILTER_FIELD_IPV4_SIP,/****5******/
    FILTER_FIELD_IPV4_DIP,/****6********/
    FILTER_FIELD_IPV4_TOS,/****7*******/
    FILTER_FIELD_IPV4_PROTOCOL,/*****8*****/
    ...
    FILTER_FIELD_VID_RANGE, /****23******/
    FILTER_FIELD_IP_RANGE,
    FILTER_FIELD_PORT_RANGE,

    FILTER_FIELD_USER_DEFINED00, /****26******/
    ...
    FILTER_FIELD_IPV6_FLOW_LABEL, /*cortina*/
...
typedef struct rtk_svlan_memberCfg_s{
    ...
    rtk_uint32 efiden;
    rtk_uint32 efid;
    rtk_uint32 index; //// CORTINA: Added by Nick for clean entry use    
...
#ifdef __CPU_SPECIAL_HANDLER
#endif

/* BEGIN: Cortina Added */

#define RTK_PKT_BUFF_LEN 2048

/* rtk special packet header */
typedef struct
{
    rtk_uint16 eth_type;            /* fixed, 0x8899 */
    rtk_uint8  proto;               /* fixed, 0x04   */
    rtk_uint8  reason;
    struct
    {
        rtk_uint8  pri      : 3;
    ...
    {
        rtk_uint8 vidx     : 5;
        rtk_uint8 lrn_flag : 1;
        rtk_uint8 vsel     : 1;
        rtk_uint8 keep     : 1;
    }__attribute__((packed)) bf2;
    rtk_uint16 port;                 /* source port for rx and destination port for tx */
}__attribute__((packed)) rtk_cpu_header_t;

#define RTK_CPU_HEADER_LEN sizeof(rtk_cpu_header_t)
...
#define SWITCH_UPLINK_PORT      6

rtk_int32 rtk_cpu_pkt_rx(rtk_uint8 *pkt, rtk_uint16 in_len, rtk_uint16 *out_len, rtk_uint8 *s_port);
rtk_int32 rtk_cpu_pkt_tx(rtk_uint8 *pkt_in, rtk_uint16 in_len, rtk_uint8 *pkt_out, rtk_uint16 *out_len, rtk_uint8 d_port);

#define __RTK_MIRROR 1

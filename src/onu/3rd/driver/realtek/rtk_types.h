...
#define swaps16(x)        \
	...
	#define rtk_ntohs(x)   (swaps16(x))
	#define rtk_ntohl(x)   (swapl32(x))
	#define rtk_htons(x)   (swaps16(x))
	#define rtk_htonl(x)   (swapl32(x))
#else
	#define rtk_ntohs(x)	(x)
	#define rtk_ntohl(x)	(x)
	#define rtk_htons(x)	(x)
	#define rtk_htonl(x)	(x)

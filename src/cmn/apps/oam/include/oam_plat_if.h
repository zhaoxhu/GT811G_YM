...
#ifndef __OAM_PLAT_IF_H__
#define __OAM_PLAT_IF_H__

#define OAM_DYING_GASP_NUM  1 /* Default value */

#define OAM_DEFAULT_PORT_NUM  1
...
cs_status  oam_plat_get_iop_vender_code(
        cs_uint8 *vcode, 
        cs_uint32 len);
cs_status  oam_plat_set_iop_vender_code(
        const cs_uint8 *vcode, 
        cs_uint32 len);

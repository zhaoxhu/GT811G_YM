...
#ifndef __OAM_API_H__
#define __OAM_API_H__
#include "cs_types.h"
void oam_send_dying_gasp(cs_llid_t llid);
cs_boolean oam_sm_discovery_completed(cs_llid_t llid);
void oam_time_msg_proc();
void oam_init();
cs_status oam_link_event_threshold_set(cs_uint8 type, cs_uint64 threshold);
cs_uint8 oam_link_event_window_set(cs_uint8 type, cs_uint32 window);

...
****************************************************************************/
#ifndef __OAM_SDL_IF_H__
#define __OAM_SDL_IF_H__
cs_status oam_sdl_send_pkt(cs_port_id_t port,cs_uint8 * buf, cs_uint32 len);
cs_status oam_sdl_get_llid_mac(cs_llid_t llid,cs_mac_t * mac);

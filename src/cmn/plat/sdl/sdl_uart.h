...
typedef cs_int32 (*cs_uart_intr_handler_t)(cs_int32,void *);
...
/* Get the installed interrupt handler */
cs_status cs_plat_uart_int_handler_get(
    CS_IN   cs_callback_context_t       context,
    CS_IN   cs_dev_id_t                 device,
    CS_IN   cs_llid_t                   llidport,
    CS_IN   cs_uint8                    uart_id,
    CS_OUT  cs_uart_intr_handler_t      *handler
);

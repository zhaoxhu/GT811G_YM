...
#define ONU_OPM_DEVICE_ADDR_0               0x50
#define ONU_OPM_OFFSET_DEVICE_ID            0x00
#define ONU_OPM_OFFSET_VENDOR_NAME          0x14
#define ONU_OPM_OFFSET_DEVICE_SN            0x44

#define ONU_OPM_DEVICE_ADDR_1               0x51
#define ONU_OPM_EEPROM_TEMP_ADDR            0x60
#define ONU_OPM_EEPROM_SVCC_ADDR            0x62    //Support Voltage
#define ONU_OPM_EEPROM_TXPBIAS_ADDR         0x64    //TX Bias current
#define ONU_OPM_EEPROM_TXPWR_ADDR           0x66
#define ONU_OPM_EEPROM_RXPWR_ADDR           0x68
#define ONU_OPM_EEPROM_STATE_ADDR           0x6E

#define ONU_OPM_LOS_BIT                     0x2

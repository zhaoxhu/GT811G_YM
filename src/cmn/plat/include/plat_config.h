 ...
 * plat_config.h
 *
 * $Id: plat_config.h,v 1.1.2.8.2.3.4.3.12.1 2013/11/28 09:17:35 swang Exp $
 */
...
#define PWRS_THREAD_STACKSIZE               (2 * 4096)
...
#define EOC_PON_THREAD_STACKSIZE            (1 * 4096)
#ifdef	HAVE_GWD_BC_LIMIT
#define PORT_BC_STORM_THREAD_STACKSIZE		(1 * 4096)
#endif
...
#define TERM_SERV_IP_RX_THREAD_PRIORITY 21
#define TERM_SERV_NET2UART_THREAD_PRIORITY 22
#define POLLING_THREAD_PRIORITY     30
#define PPP_THREAD_PRIORITY     13
#define EOC_PON_THREAD_PRIORITY     12
#ifdef	HAVE_GWD_BC_LIMIT
#define PORT_BC_STORM_THREAD_PRIORITY	24
#endif
...
#define PWRS_THREAD_NAME            "PWRS Thread"

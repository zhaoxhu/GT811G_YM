...
//        flash.c
//
//        ARM IMST A/P FLASH program tool
//
//==========================================================================
...
//
// This program will program the FLASH on IMST A/P board
//
...
#define IMST_EBI_BASE 0x12000000

#define IMST_EBI_CSR0_OFFSET      0x00
#define IMST_EBI_CSR1_OFFSET      0x04
#define IMST_EBI_CSR2_OFFSET      0x08
#define IMST_EBI_CSR3_OFFSET      0x0C
#define IMST_EBI_LOCK_OFFSET      0x20

#define IMST_EBI_CSR0 (IMST_EBI_BASE + IMST_EBI_CSR0_OFFSET)
#define IMST_EBI_CSR1 (IMST_EBI_BASE + IMST_EBI_CSR1_OFFSET)
#define IMST_EBI_CSR2 (IMST_EBI_BASE + IMST_EBI_CSR2_OFFSET)
#define IMST_EBI_CSR3 (IMST_EBI_BASE + IMST_EBI_CSR3_OFFSET)
#define IMST_EBI_LOCK (IMST_EBI_BASE + IMST_EBI_LOCK_OFFSET)

#define IMST_EBI_8_BIT            0x00
#define IMST_EBI_16_BIT           0x01
#define IMST_EBI_32_BIT           0x02
#define IMST_EBI_WRITE_ENABLE     0x04
#define IMST_EBI_SYNC             0x08
#define IMST_EBI_WS_2             0x00
#define IMST_EBI_WS_3             0x10
#define IMST_EBI_WS_4             0x20
#define IMST_EBI_WS_5             0x30
#define IMST_EBI_WS_6             0x40
#define IMST_EBI_WS_7             0x50
#define IMST_EBI_WS_8             0x60
#define IMST_EBI_WS_9             0x70
#define IMST_EBI_WS_10            0x80
#define IMST_EBI_WS_11            0x90
#define IMST_EBI_WS_12            0xA0
#define IMST_EBI_WS_13            0xB0
#define IMST_EBI_WS_14            0xC0
#define IMST_EBI_WS_15            0xD0
#define IMST_EBI_WS_16            0xE0
#define IMST_EBI_WS_17            0xF0
...
{
     volatile unsigned int *ebi_csr1 = (volatile unsigned int *)IMST_EBI_CSR1;

     // allow write access to EBI_CSR1 area (Flash)

     *ebi_csr1 |= IMST_EBI_WRITE_ENABLE;

     if (!(*ebi_csr1 & IMST_EBI_WRITE_ENABLE)) {
	 *(volatile unsigned int *)IMST_EBI_LOCK = 0xA05F;
	 *ebi_csr1 |= IMST_EBI_WRITE_ENABLE;
	 *(volatile unsigned int *)IMST_EBI_LOCK = 0;
     }

     /* Enable Vpp and allow write access to Flash in system controller */

     *(volatile unsigned int *)IMST_SC_CTRLS = FL_SC_CONTROL;
}
...
flashWriteDisable(void)
{
	 ...
	 *(volatile unsigned int *)IMST_EBI_LOCK = 0xA05F;
	 *ebi_csr1 &= ~IMST_EBI_WRITE_ENABLE;
	 *(volatile unsigned int *)IMST_EBI_LOCK = 1;
     }

     // Disable Vpp and disable write access to Flash in system controller

     *(volatile unsigned int *)IMST_SC_CTRLS = 0;
}

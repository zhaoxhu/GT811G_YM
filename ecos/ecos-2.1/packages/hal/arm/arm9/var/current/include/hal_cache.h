...
// locked at any one time. This area must be 4kB or less in size.
...
CYG_MACRO_START                                                                 \
    ...
    for ( addr = (~(HAL_ICACHE_LINE_SIZE - 1)) & (int)(_base_),                 \
              enda = (int)(_base_) + (_size_);                                  \
          addr < enda ;                                                         \
          addr += HAL_ICACHE_LINE_SIZE )                                        \
    {                                                                           \
        asm volatile (                                                          \
                      "mcr  p15,0,%0,c7,c13,1;" /* load instruction */          \
                      :                                                         \
                      : "r"(addr)                                               \
                      : "memory"                                                \
            );                                                                  \
...
CYG_MACRO_START                                                                 \
    ...
    {                                                                           \
        asm volatile (                                                          \
                      "ldr  r0, [%0], #32;" /* load data into cache */          \
                      :                                                         \
                      : "r"(addr)                                               \
                      : "memory"                                                \
            );                                                                  \

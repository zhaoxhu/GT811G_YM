...
flash_query(void* data)
{
    ...
    ROM = (volatile flash_data_t*) jffs2_flash_base_address;
                  ...
                  unsigned long block_mask, int buffer_size)
{
    ...
    CYGHWR_FLASH_WRITE_ENABLE();
#ifdef CYGHWR_IO_FLASH_BLOCK_LOCKING
    flash_unlock_block(BA, flash_dev_info->block_size, 1);
#endif
    ...
    while (len > 0) {
        ...
        /* Program the location for write */
        /* For Intel program the base address of any where in the  
         * block is good enough. But for Sharp the location holds   
         * data need to be set to program first. And it works for   
         * Intel too.
         */
        //ROM[0] = FLASH_Program;
        ...
        *addr_v = *data_p;
        ...
        /* move to next 2byte (at cortina) to write */

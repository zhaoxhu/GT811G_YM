...
#define DHCP_FILE_LEN 128U
  ...
  // set the min len to the length of option 60
#define DHCP_MIN_OPTIONS_LEN 128U
...
/*add for dhcp eamulte*/
typedef void (*app_dhcp_handler_t)(void);

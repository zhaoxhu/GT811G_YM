...
#define AUTH_STORAGE_BUFFER_LENGTH_LOGIN             64
#define AUTH_STORAGE_BUFFER_LENGTH_PASSWORD          64
...
cyg_httpd_auth_table_entry* cyg_httpd_is_authenticated_private(char*);
...
/* add handler for auth call back*/
typedef unsigned char (*cyg_auth_handler)(char *user, char *passwd);
typedef void (*cyg_get_cookie_handler)(char * cookieStr);
typedef unsigned char (*cyg_get_access_status_handler)(void);
...
unsigned char cyg_auth_access_status_get(void);
#endif // __AUTH_H__
